...
export async function initializeAiConfig(env: Env): Promise<void> {
  ...
  const defaultConfigs: Array<{
    ...
    {
      key: 'ai.agent.max_tokens',
      category: 'agent',
      label: 'Agent最大Token数',
      description: 'Agent对话响应时的最大输出token数',
      valueType: 'number',
      defaultValue: '2048',
      isEditable: true,
      sortOrder: 13,
    ...
    {
      key: 'ai.agent.reserve_tokens',
      category: 'agent',
      label: '预留Token数',
      description: '为响应预留的token数',
      valueType: 'number',
      defaultValue: '2500',
      isEditable: true,
      sortOrder: 18,
    ...
    {
      key: 'ai.agent.max_tool_result_chars',
      category: 'agent',
      label: '工具结果最大字符数',
      description: '单个工具结果的最大字符数（超长会被截断）',
      valueType: 'number',
      defaultValue: '15000',
      isEditable: true,
      sortOrder: 19,
    ...
    {
      key: 'ai.summary.max_tokens',
      category: 'feature',
      label: '摘要最大Token数',
      description: '生成文件摘要时的最大输出token数',
      valueType: 'number',
      defaultValue: '200',
      isEditable: true,
      sortOrder: 23,
    ...
    {
      key: 'ai.image_caption.max_tokens',
      category: 'feature',
      label: '图片描述最大Token数',
      description: '生成图片描述时的最大输出token数',
      valueType: 'number',
      defaultValue: '2048',
      isEditable: true,
      sortOrder: 24,
    ...
    {
      key: 'ai.image_tag.max_tokens',
      category: 'feature',
      label: '图片标签最大Token数',
      description: '生成图片标签时的最大输出token数',
      valueType: 'number',
      defaultValue: '1024',
      isEditable: true,
      sortOrder: 25,
    ...
    {
      key: 'ai.rename.max_tokens',
      category: 'feature',
      label: '重命名最大Token数',
      description: '智能重命名建议时的最大输出token数',
      valueType: 'number',
      defaultValue: '150',
      isEditable: true,
      sortOrder: 26,
    ...
    },
    {
      ...
      category: 'prompt',
      label: '文档摘要提示词（暂未启用）',
      description: '⚠️ 暂未启用：Office/PDF等文档类型暂不支持AI摘要，此配置保留备用',
      valueType: 'string',
    ...
    },
    {
      ...
      category: 'prompt',
      label: '表格数据摘要提示词（暂未启用）',
      description: '⚠️ 暂未启用：Excel等表格文件暂不支持AI摘要，此配置保留备用',
      valueType: 'string',
