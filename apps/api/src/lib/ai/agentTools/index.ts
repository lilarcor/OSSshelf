...
export function getToolsByCategory(): Record<string, string[]> {
  const categories: Record<string, string[]> = {
    ...
    '📂 目录导航': ['navigate_path', 'list_folder', 'get_recent_files', 'get_starred_files', 'get_parent_chain', 'get_folder_tree', 'get_storage_overview'],
    '📊 统计分析': [
      'get_storage_stats',
      'get_activity_stats',
      'get_user_quota_info',
    ...
    '💾 存储管理': ['get_storage_usage', 'get_large_files', 'get_folder_sizes', 'get_cleanup_suggestions', 'list_buckets', 'get_bucket_info', 'set_default_bucket', 'migrate_file_to_bucket'],
    '⚙️ 系统管理': [
      'get_system_status',
      'get_help',
      'get_version_info',
