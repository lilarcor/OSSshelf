-- 添加AI提供商表和扩展AI模型表
-- 添加 ai_providers 表用于管理自定义提供商（OpenAI兼容API）
...
VALUES 
  ...
  ('vendor-anthropic', NULL, 'Anthropic Claude', 'https://api.anthropic.com/v1', 'Anthropic Claude系列模型（需使用兼容适配器）', '{"paramFormat":"object","paramName":"thinking","nestedKey":"type","enabledValue":"enabled","disabledValue":"disabled"}', 1, 0, 1, 89, datetime('now', 'localtime'), datetime('now', 'localtime')),
