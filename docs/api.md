...
- [AI 功能接口](#ai-功能接口) - v3.7.0, v4.1.0 独立文档
...
> **v4.7.0 更新**: AI 相关 API 已独立为专门文档，请参阅 **[AI API 文档](./API_AI.md)**。

AI 功能包括：

- **AI 配置管理**：模型管理、功能级配置、连接测试
- **AI 对话系统**：会话管理、SSE 流式聊天、RAG 文件问答
- **AI 文件处理**：文件摘要、图片标签、智能重命名、语义搜索
- **批量操作**：一键摘要、一键标签、一键索引（支持取消/超时控制）
- **跨会话记忆**（v4.7.0 新增）：记忆列表查询、单条删除（`/api/ai/memories`）

详细 API 文档请参阅：**[docs/API_AI.md](./API_AI.md)**
